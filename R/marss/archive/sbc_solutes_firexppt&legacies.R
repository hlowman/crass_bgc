...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_nh4_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_nh4_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# and save out plot
# ggsave(("figures/MARSS_SB_5state_nh4_2y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# check for NaNs (not allowed) and NAs (allowed in response but not predictors)
sum(is.nan(dat_no3_log[,resp_cols])) # 0
sum(is.na(dat_no3_log[,resp_cols])) # 293
range(dat_no3_log[,resp_cols], na.rm = T)
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
...
# Plot 6 (qqplot.std.model.resids.ytt1: Are resids normal?
# These are qq plots that should look like a straight line. Datasets with many missing values will not be normal - this isn't a violation per se, but rather you must look at residuals with those associated with missing values removed. 
# These look good! WAY better than NH4.
...
(RESULTS_ALL_no3 <- ggplot(CIs_fit_ed, aes(Parameter, Est., color=Region)) + 
    ...
    coord_flip() +
    labs(y = "",
         title = "Nitrate (NO3) MARSS modeling results - 01/17/2023\nImmediate Effects") +
    theme(plot.margin=unit(c(.2,.2,.05,.05),"cm")) + 
    facet_wrap(Region~Site, scales = "free"))

# Precip really seems to be the driving factor here.

# and save out plot
# ggsave(("figures/MARSS_SB_6state_no3_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_no3_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
...
# Some *slight* fire effects emerging.

# and save out plot
# ggsave(("figures/MARSS_SB_5state_no3_1y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# Precip again is the driving factor it seems.

# and save out plot
# ggsave(("figures/MARSS_SB_5state_no3_2y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_no3_percburn5ylegacy_percburnxppt5ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn5ylegacy_percburnxppt5ylegacy_mBFGS.rds")
...
# Yep - precip is most important.

# and save out plot
# ggsave(("figures/MARSS_SB_5state_no3_5y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# import model fits
noleg_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
leg1y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
leg2y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
leg5y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_no3_percburn5ylegacy_percburnxppt5ylegacy_mBFGS.rds")
...
# Export plot.
# ggsave(("MARSS_SB_NO3_011723.png"),
#        path = "figures",
#        width = 80,
#        height = 10,
#        units = "cm"
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
...
# Plot 5 (std.state.resids.xtT): These residuals can be used to detect outliers. Looks ok! Better than both NH4 and NO3.
...
# and save out plot
# ggsave(("figures/MARSS_SB_5state_po4_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_po4_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
...
# And it really seems like many of the issues I was encountering have been smoothed over using the volume weighted values.
...
# and save out plot
# ggsave(("figures/MARSS_SB_5state_po4_1y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# export model fit
saveRDS(fit, 
        file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# import model fit
fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
# Precip again seems to be the primary driver.

# and save out plot
# ggsave(("figures/MARSS_SB_5state_po4_2y_011723.png"),
#        width = 30,
#        height = 15,
#        units = "cm"
# )
...
# import model fits
noleg_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2m_percburn6mxppt_nolegacies_mBFGS.rds")
leg1y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn1ylegacy_percburnxppt1ylegacy_mBFGS.rds")
leg2y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn2ylegacy_percburnxppt2ylegacy_mBFGS.rds")
...
leg5y_fit = readRDS(file = "data_working/marss_test_run/fit_011723_5state_po4_percburn5ylegacy_percburnxppt5ylegacy_mBFGS.rds")
...
# Export plot.
# ggsave(("MARSS_SB_PO4_011723.png"),
#        path = "figures",
#        width = 80,
#        height = 10,
#        units = "cm"
